...
pause_img= pygame.image.load("images/Screenshot 2024-05-22 114303 1 (1).png")
pygame.init()
...
class Button() :
    ...
    def draw(self, screen,joueur, score, scene):
        screen.blit(self.image, self.rect)
        pos = pygame.mouse.get_pos()
        if self.rect.collidepoint(pos) :
            if pygame.mouse.get_pressed()[0] ==1 and self.clicked ==False :
                print(f"joueur:{joueur}")
                sauvegarder_partie(joueur, score, scene)
                popup.visible = True
                self.clicked = True
                

popup = Popup(150, 150, 200, 50, "well saved game")
button = Button(775 , 20 , pause_img)
...
class Scene:
    ...
    def draw(self, screen):
        ...
        taptocn=font.render("Tap Enter To Continue",1,'white')
        screen.blit(taptocn,(700,570))
...
class debut(Scene):
   def __init__(self):
        super().__init__(
            "",
            image= pygame.image.load("images/new level.png"),
            actions=["next"],
            action_key_mapping={"next": pygame.K_RETURN}
        )
...
class name(Scene):
    def __init__(self):
        super().__init__(
            "",
            image=pygame.image.load("images/new level (1).png"),
            actions=["next"],
            action_key_mapping={"next": pygame.K_RETURN}
        )
        self.user_input = ""
    ...
    def draw(self, screen):
        ...
        font = pygame.font.SysFont(self.font, 17)
        user_input_surface = font.render(self.user_input, True, 'white')
        screen.blit(user_input_surface, (430, 460))
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_BACKSPACE:
                ...
                if self.user_input:  # Check if there's input
                    ...
                    print(f"Player's name saved: {self.joueur}")  # Debug print
...
class nameCONTINUE(Scene): 
    def __init__(self):
        super().__init__(
            "",
            image=pygame.image.load("images/new level (2).png"),
            actions=["next"],
            action_key_mapping={"next": pygame.K_RETURN}
        )
        self.user_input = ""
...
class WoodsScene(Scene):
    def __init__(self):
        super().__init__(
            ...
            image=pygame.image.load("images/photo_2024-05-21_18-02-32 (1) (3).png") ,
            actions=["next"],
            action_key_mapping={"next": pygame.K_RETURN}
        )
...
class GhostScene(Scene):
    def __init__(self):
        super().__init__(
            ...
            image=pygame.image.load("images/Haunted Woods - Woodland Monsters - Dark Forest Horror Aesthetics - Ghosts & Horrors - Artworks (1).png"),
            actions=["yes","no"],
            action_key_mapping={"yes": pygame.K_1, "no": pygame.K_0}
        )
    def handle_input(self, event):
...
class Scene5(Scene):#done scene5
    ...
    def __init__(self):
        super().__init__(
            ...
            image = pygame.image.load("images/photo_2024-05-22_08-28-32.png"),
            actions=["next"],
            action_key_mapping={"next": pygame.K_RETURN},
...
class Scene6(Scene):#done scene6
     def __init__(self):
        super().__init__(
            "You are very scared from what you saw in that house you went to the exit door\n"
            "but it was close, and then you felt something hits your head so hard! \n"
            "Everything turned black             \n"
            "OHH NO,what's happening ?\nYOU FAINTED!...",
...
class Scene7(Scene):#done scene 7
    def __init__(self):
        super().__init__(
            "Once you opened your eyes slowely... "
...
class Scene_level1_1(Scene):#done debut of level
    def __init__(self):
        super().__init__(
            "                                                    ETHERIA ' THE LOST LAND ',2689",
            image = pygame.image.load("images/photo_2024-05-22_08-28-50.png"), 
            actions=["next"],
            action_key_mapping={"next": pygame.K_RETURN}
    ...
    def __init__(self):
        super().__init__(
            "Bigboy: \"I am the man who will guid you here in this land ...\nI'll help you to find the door that will take you back to your world\"",
             image= pygame.image.load("images/photo_2024-05-22_08-47-07.png"),
            actions=["next"],
            action_key_mapping={"next": pygame.K_RETURN}
...
class Scene_level1_4(Scene):#senne 4 level
    def __init__(self):
        super().__init__(
            "Bigboy: \"There are a bunch of missions you have to complete, "
            "you have to solve all the enigmas so \nhere is the card that will help you to find the door.\" ",
            image=pygame.image.load("images/Frame 29.png"),
            actions=["next"],
            action_key_mapping={"next": pygame.K_RETURN}
...
class Scene_level1_5(Scene):#scene5 level
    def __init__(self):
        super().__init__(
            ...
            ,
            image=pygame.image.load("images/photo_2024-05-22_09-03-37.png"),
...
class Scene_level1_s1l(Scene):#scene 6level
    def __init__(self):
        super().__init__(
            ...
            image=pygame.image.load("images/Frame 8.png"),
...
class Scene_level1_s1(Scene):#scene 7 sea road
    def __init__(self):
        super().__init__(
            ...
            image= pygame.image.load("images/Frame 7.png"),
            actions=["yes","no"],
...
class Scene_level1_s2_swiming(Scene):#scene 8 swiming
    def __init__(self):
        super().__init__(
            ...
            image=pygame.image.load("images/Frame 9.png"),
            actions=["yes","no"],
            action_key_mapping={"yes": pygame.K_1,"no": pygame.K_2}
...
class Scene_level1_s2_noswiming_boat(Scene):#scene 12
    def __init__(self):
        super().__init__( 
            ...
            image=pygame.image.load("images/Frame 19.png"),
            actions=["boat","land"],
...
class DesertScene(Scene):
    def __init__(self):
        super().__init__(
            ...
            image=pygame.image.load("images/photo_2024-05-22_22-56-42.png"),
            actions=["next"],
            action_key_mapping={"next": pygame.K_RETURN}
        )
...
class BoxClosedScene(Scene):
    def __init__(self):
        super().__init__(
            "While admiring this magical forest  you saw something glowing in the distance.\n"
            "You approach to see what it is. Oh! It's a big golden box.\n"
            "Do you want to open it?\nTap (0) For: No\nTap (1) For: Yes" ,
            image=pygame.image.load("images/photo_2024-05-22_22-10-11 1.png"),
            actions=["yes","no"],
            action_key_mapping={"yes": pygame.K_1, "no": pygame.K_0}
        )
    def handle_input(self, event):
...
class BoxOpenedScene(Scene):
    def __init__(self):
        super().__init__(
            ...
            image=pygame.image.load("images/Frame 33.png"),
            actions=["next"],
            action_key_mapping={"next": pygame.K_RETURN},
...
class TheftScene(Scene):
    def __init__(self):
        super().__init__(
            ...
            image= pygame.image.load("images/Frame 1 1.png"),
            actions=["next"],
            action_key_mapping={"next": pygame.K_RETURN},
...
class ScoreScene(Scene):
    def __init__(self):
        super().__init__(
            "",
            image=pygame.image.load("images/new level (4).png"),
            actions=["next"],
            action_key_mapping={"next": pygame.K_RETURN}
        )
    ...
    def __init__(self):
        super().__init__(
            ...
            "until the end of the level. The letter is 'R'.",
             image=pygame.image.load("images/Frame 32.png"),
            actions=["next"],
            action_key_mapping={"next": pygame.K_RETURN},
...
class BroomScene(Scene):
    def __init__(self):
        super().__init__(
            ...
            "Tap (0) for: No\n"
            "Tap (1) for: Yes",
            image=pygame.image.load("images/photo_2024-05-22_23-02-14 1.png"),
            actions=["yes","no"],
            action_key_mapping={"yes": pygame.K_1, "no": pygame.K_0}
        )
    def handle_input(self, event):
...
class MagicBroom(Scene):
    def __init__(self):
        super().__init__(
            ...
            image=pygame.image.load("images/Frame 15.png"),
            actions=["next"],
            action_key_mapping={"next": pygame.K_RETURN},
...
class Bird(Scene):
    def __init__(self):
        super().__init__( 
            ...
            image=pygame.image.load("images/photo_2024-05-22_22-56-56.png"),
            actions=["next"],
            action_key_mapping={"next": pygame.K_RETURN}
        )
...
class Amazone(Scene):
    def __init__(self):
        super().__init__(
            ...
            image=pygame.image.load("images/Frame 12.png"),
            actions=["next"],
            action_key_mapping={"next": pygame.K_RETURN}
        )
...
class Treeclimb(Scene):
    def __init__(self):
        super().__init__(
            ...
            image=pygame.image.load("images/photo_2024-05-22_23-39-39 1.png"),
            actions=["next"],
            action_key_mapping={"next": pygame.K_RETURN}
        )
...
class Attack(Scene):
    def __init__(self):
        super().__init__(
            ...
            image=pygame.image.load("images/Frame 28.png"),
...
class Fight(Scene):
    def __init__(self):
        super().__init__(
            ...
            image=pygame.image.load("images/OIG3 1.png"),
...
class Success(Scene):
    def __init__(self):
        super().__init__(
            "you wonnn the turbo is functioning ",
            image=pygame.image.load("images/Frame 1 (1) 1.png"),
            actions=["next"],
            action_key_mapping={"next": pygame.K_RETURN},
            sound="sounds/right-answer.mp3"
...
class Cave(Scene):
    def __init__(self):
        super().__init__(
            ...
            """,
            image=pygame.image.load("images/Frame 1 (2).png"),
            actions=["next"],
            action_key_mapping={"next": pygame.K_RETURN}
        )
...
class Sound(Scene):
    def __init__(self):
        super().__init__(
            ...
            """,
            image=pygame.image.load("images/_04afc994-3c53-42fe-b8c8-45feeec3038f (2).png"),
            actions=["next"],
            action_key_mapping={"next": pygame.K_RETURN},
...
class Startfight(Scene):
    def __init__(self):
        super().__init__(
            ...
            """,
            image=pygame.image.load("images/new level (6).png"),
            actions=["next"],
            action_key_mapping={"next": pygame.K_RETURN}
        )
