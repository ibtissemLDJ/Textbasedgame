...
class Scene:
    ...
    def draw(self, screen):
        ...
        # Render text on the dark background
        font = pygame.font.SysFont("Arial", 17)
        text_surface = font.render(self.text, True, 'white')
        screen.blit(text_surface, (10, 320))  # Adjusted y-coordinate for text
...
class WoodsScene(Scene):
    def __init__(self):
        super().__init__(
           "You are isolated in the woods ,surrounded by darkness and the distant  howls of wolves.",
           image=image1,
            actions=["next"],
           action_key_mapping = {
...
class HauntedScene(Scene):
    def __init__(self):
        super().__init__( "As you navigate through the haunted woods, strange sounds fill  the air, making you feel uneasy  "
